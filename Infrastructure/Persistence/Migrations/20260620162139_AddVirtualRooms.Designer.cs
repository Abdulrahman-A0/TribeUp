...
namespace Persistence.Migrations
{
    ...
    [Migration("20260620162139_AddVirtualRooms")]
    partial class AddVirtualRooms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Engagement.EventParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.VirtualRooms.RoomParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VirtualRoomId", "UserId")
                        .IsUnique();

                    b.ToTable("RoomParticipants");
                });

            modelBuilder.Entity("Domain.Entities.VirtualRooms.VirtualRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Engagement.EventParticipant", b =>
                {
                    b.HasOne("Domain.Entities.Engagement.Event", "Event")
            ...
            modelBuilder.Entity("Domain.Entities.VirtualRooms.RoomParticipant", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.VirtualRooms.VirtualRoom", "VirtualRoom")
                        .WithMany("Participants")
            ...
            modelBuilder.Entity("Domain.Entities.VirtualRooms.VirtualRoom", b =>
                {
                    b.HasOne("Domain.Entities.Groups.Group", "Group")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.VirtualRooms.VirtualRoom", "GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
